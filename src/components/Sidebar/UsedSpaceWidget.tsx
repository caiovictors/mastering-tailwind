    ...
    <div className="flex flex-col gap-4 rounded-lg bg-violet-50 px-4 py-5 dark:bg-zinc-800">
      <div className="space-y-1">
        ...
        <p className="text-sm/5 text-violet-500 dark:text-zinc-400">
          Your team had used 80% of your available space. Need more?
        </p>
      </div>
      ...
      <div className="space-x-3">
        <button
          type="button"
          className="text-sm font-medium text-violet-500 hover:text-violet-700 dark:text-violet-300 dark:hover:text-zinc-200"
        >
          Dismiss
        </button>
        <button

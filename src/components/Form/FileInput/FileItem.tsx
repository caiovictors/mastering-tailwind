...
import { CheckCircle2, CloudUpload, Trash2 } from 'lucide-react'
  ...
  variants: {
    state: {
      ...
      error: {
        ...
        icon: 'border-error-50 bg-error-100 text-error-600 dark:bg-error-5005 dark:border-error-500/30 dark:text-error-400',
        deleteButton:
          'text-error-700 hover:text-erorr-900 dark:text-error-400 dark:hover:text-error-300',
      },
    },
  },
  defaultVariants: {
      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            ...
            <span className="text-sx max-w-52 truncate text-error-600 2xl:w-full 2xl:max-w-full dark:text-error-500">
              {name}
            </span>
          </div>

  ...
  variants: {
    state: {
      ...
      error: {
        ...
        deleteButton: 'text-error-700 hover:text-erorr-900',
      },
    },
  },
  defaultVariants: {
      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            ...
            <span className="text-sx text-error-600">{name}</span>
          </div>
        ...
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            ...
            <span className="text-sx text-zinc-500">{formatBytes(size)}</span>
          </div>
